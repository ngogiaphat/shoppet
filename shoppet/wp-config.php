<?php
	 ...
	 * installation. You don't have to use the web site, you can copy this file to "wp-config.php" and fill in the values. This file contains the following configurations:
	 * * MySQL settings
	 * * Secret keys
	...
	/**#@+
	 * Authentication Unique Keys and Salts. Change these to different unique phrases!
	...
	*/
	$table_prefix = 'wp_';
	/**
	 * For developers: WordPress debugging mode. Change this to true to enable the display of notices during development.
