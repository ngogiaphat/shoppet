this["wp"] = this["wp"] || {}; this["wp"]["a11y"] = (function(modules){ // webpackBootstrap
  // The module cache
...
({"Y8OO":(function(module, exports){
  ...
  (function(module, __webpack_exports__, __webpack_require__){
    ...
    __webpack_require__.d(__webpack_exports__, "setup", function(){
      return /* binding */ build_module_setup; 
    });
    __webpack_require__.d(__webpack_exports__, "speak", function(){ 
      return /* binding */ build_module_speak; 
    });
    ...
    */
    var filterMessage = function filterMessage(message) {
      /*
        * Strip HTML tags (if any) from the message string. Ideally, messages should be simple strings, carefully crafted for specific use with A11ySpeak.
        * When re-using already existing strings this will ensure simple HTML to be stripped out and replaced with a space. Browsers will collapse multiple spaces natively.
      */
    ...
    */
     ...
     * @param {string} ariaLive Optional. The politeness level for aria-live. Possible values: polite or assertive. Default polite.
     * @example
     * ```js
